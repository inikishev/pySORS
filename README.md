...
They have a lot of hyperparameters though, and I just copied them from the original repo. In particular step size tends to decay very quickly. So this is not particularly useful for black box optimization unless you do a lot of careful hyperparameters tuning, which I might do at some point on some diverse set of problems. 

I made this fork mainly for benchmarking because I couldn't find any libraries that have those methods readily available.
